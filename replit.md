...
- C-Lists only have E permission, [CLOOMC](https://sipantic.blogspot.com/2025/03/xx.html) only X or RX
...
- **NS Entry and Lump Layout:** Defines the structure of Namespace entries and memory lumps for abstractions. Lumps are power-of-2 allocated (minimum 32 words). Code at offset 0, c-list at allocSize-clistCount, freespace between. Boot.Abstr (NS[2]) is a combined slot holding both boot code and C-List GTs using the clistCount split. NS[3] is empty (was Boot.[CLOOMC](https://sipantic.blogspot.com/2025/03/xx.html), now merged). C-List[0] is NULL (was Boot.[CLOOMC](https://sipantic.blogspot.com/2025/03/xx.html) GT).
...
1. **Free Platform (GPL-3.0):** Core IDE, simulator, [CLOOMC](https://sipantic.blogspot.com/2025/03/xx.html)++ compiler, shared library, and CTMM hardware designs — free for all students, parents, teachers, schools (K-12), IB programmes, universities, homeschool, and non-profit academic research.
...
3. **Commercial License:** For-profit use requires separate commercial license from [CLOOMC](https://sipantic.blogspot.com/2025/03/xx.html) Technologies LLC. Contact: SIPanticINC@gmail.com.
