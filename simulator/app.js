...
const BOOT_SEQ_CODE = {
    ...
    0: [
        ...
        '',
        '; ━━━ B:00  FAULT_RST ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        '; Power-on reset: wipe all architectural state before loading any GT.',
        '; Runs unconditionally at every cold or warm reset.',
        'B:00  FAULT_RST',
        '      for i in 0..15: CRi ← NULL    ; clear all 16 capability registers',
        '      for i in 0..15: DRi ← 0       ; zero all 16 data registers',
        '      M-Elevation ← ON              ; bypass R/W/X/L perms during boot',
        '',
        '; ━━━ B:01  LOAD_NS ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        ...
        '      entry ← mLoad(GT15, perm=none) ; M-elevation active — validates NS entry',
        '      CR15  ← { word0=GT15,          ; Golden Token for Slot 0',
    ...
    1: [
        ...
        '      entry ← mLoad(GT12, perm=none) ; M-elevation active — validates thread NS entry',
        '      CR12  ← { word0=GT12,          ; thread identity token',
    ...
    2: [
        ...
        '      entry ← mLoad(GT6a, perm=none) ; M-elevation validates NS entry for Slot 2',
        '      CR6   ← { word0=GT6a, … }      ; temporary E-type token — saved to stack frame in B:04',
        ...
        'B:05  COMPLETE',
        '      M-Elevation ← OFF                       ; normal capability checks now apply',
