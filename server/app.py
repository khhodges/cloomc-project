...
- `church_ti60_f225.peri.xml` — Periphery configuration (PLL, I/O banks, UART pins)
- `ti60_f225.isf`             — Pin constraints (Interface Setup File, import if regenerating peri.xml)
- `BUILD.md`                  — This file

## Quick Start

### Step 1 — Open in Efinity IDE
...
Everything is pre-configured — periphery file, timing constraints, and programmer target are all set.
