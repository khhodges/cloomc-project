...
class CTMMMSave(Elaboratable):
    def __init__(self):
        self.sub_start = Signal()
        self.sub_dst_cap = Signal(CAP_REG_LAYOUT)
        self.sub_src_gt = Signal(64)
        self.sub_index = Signal(8)
    ...
    def elaborate(self, platform):
        ...
        write_addr = Signal(64)
        m.d.comb += write_addr.eq(dst_view.word1_location + (Cat(index_reg, Const(0, 56)) << 3))
