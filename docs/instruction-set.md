...
|  8   | E     | E |
|  9   | LS    | L, S |
| 10   | RSV3  | **FAULT** (`TPERM_RSV`) — unconditionally reserved |
| 11   | RSV4  | **FAULT** (`TPERM_RSV`) — unconditionally reserved |
| 12   | RSV5  | **FAULT** (`TPERM_RSV`) — unconditionally reserved |
...
| 15   | RSV1  | **FAULT** (`TPERM_RSV`) — unconditionally reserved |
