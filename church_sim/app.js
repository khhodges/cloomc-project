...
function renderPagesDirectory() {
    ...
    el('pagesFigures').innerHTML = [
        ...
        card('/figures/lambda-calculus-mapping', 'Fig 6: Lambda Mapping', 'figure', td, 'Lambda calculus to CTMM hardware mapping.'),
        card('/figures/lambda-clamp-example', 'Fig 7: LAMBDA Clamp', 'figure', td, 'Macro-like code reuse.'),
        card('/figures/tunnel-architecture', 'Fig 8: Tunnel Architecture', 'figure', td, 'Encrypted capability tunnel between Meta Machines.'),
        card('/figures/dispatch-styles-comparison', 'Fig 9: Dispatch Styles', 'figure', td, 'Same CALL, three resolutions.'),
        card('/figures/conventional-vs-ctmm', 'Fig 10: Conventional vs CTMM', 'figure', td, 'Attack surface elimination.'),
        card('/figures/boot-sequence-state-machine', 'Fig 11: Boot Sequence', 'figure', td, '5-phase hardware initialization.'),
        card('/figures/mload-validation-pipeline', 'Fig 12: mLoad Pipeline', 'figure', td, 'Five sequential validation checks.'),
