...
function renderPagesDirectory() {
    ...
    el('pagesFigures').innerHTML = [
        ...
        card('/figures/lambda-clamp-example', 'Fig 8: LAMBDA Clamp', 'figure', td, 'Macro-like code reuse.'),
        card('/figures/tunnel-architecture', 'Fig 9: Tunnel Architecture', 'figure', td, 'Encrypted capability tunnel between Meta Machines.'),
        card('/figures/dispatch-styles-comparison', 'Fig 10: Dispatch Styles', 'figure', td, 'Same CALL, three resolutions.'),
        card('/figures/conventional-vs-ctmm', 'Fig 11: Conventional vs CTMM', 'figure', td, 'Attack surface elimination.'),
        card('/figures/boot-sequence-state-machine', 'Fig 12: Boot Sequence', 'figure', td, '5-phase hardware initialization.'),
        card('/figures/mload-validation-pipeline', 'Fig 13: mLoad Pipeline', 'figure', td, 'Five sequential validation checks.'),
        card('/figures/mint-abstraction-nesting', 'Fig 14: Mint Abstraction', 'figure', td, 'Abstraction nesting and domain purity.'),
        card('/figures/hello-mum-tunnel', 'Fig 15: Hello Mum Tunnel', 'figure', td, 'Encrypted capability tunnel example.'),
    ].join('');
