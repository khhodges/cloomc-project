...
function renderPagesDirectory() {
    ...
    el('pagesFigures').innerHTML = [
        ...
        card('/figures/lambda-clamp-example', 'Fig 20: LAMBDA Clamp', 'figure', td, 'Macro-like code reuse.'),
        card('/figures/tunnel-architecture', 'Fig 21: Tunnel Architecture', 'figure', td, 'Encrypted capability tunnel between Meta Machines.'),
        card('/figures/dispatch-styles-comparison', 'Fig 22: Dispatch Styles', 'figure', td, 'Same CALL, three resolutions.'),
        card('/figures/conventional-vs-ctmm', 'Fig 23: Conventional vs CTMM', 'figure', td, 'Attack surface elimination.'),
        card('/figures/boot-sequence-state-machine', 'Fig 24: Boot Sequence', 'figure', td, '5-phase hardware initialization.'),
...
`,
        'version_attack': `; ============================================
; ADVERSARIAL TEST: CR Re-aim Verification
; Loading a new GT into a CR replaces the
; old one — mLoad validates the new GT.
; ============================================
...
; --- Re-aim CR0 to a different abstraction ---
; mLoad validates version, seal, and permissions
LOAD CR0, CR6, 12      ; CR0 re-aimed to ADD
TPERM CR0, LE          ; Verify ADD has L+E? PASS

; --- Reload same entry ---
LOAD CR1, CR6, 10      ; CR1 re-loaded with SUCC
TPERM CR1, LE          ; Verify SUCC still valid? PASS
...
LOAD CR0, CR6, 4       ; Lambda    (E)
LOAD CR1, CR6, 10      ; SUCC      (XLE)
LOAD CR2, CR6, 8       ; Stack     (E)
LOAD CR3, CR6, 12      ; ADD       (XLE)
LOAD CR4, CR6, 7       ; Constants (E)
LOAD CR5, CR6, 5       ; SlideRule (E)
...
LOAD CR5, CR6, 27      ; CR5 = GC (overwrite SlideRule)
CALL CR5               ; Trigger GC abstraction
